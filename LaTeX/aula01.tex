...
\usepackage{templates/darkaccent}

\title{Introdução ao Estudo de\\[4pt] Equações Diferenciais Ordinárias}
\subtitle{Introdução a EDO (Aula 1)}
\author{Prof. Saulo Henrique}
...
\figuraabnt[
  legenda={Decaimento radioativo},                % EDITAR
  fonte={Elaborado pelo autor (2026).},
  rotulo=fig:decaimento
]{figuras/decaimento_radioativo.png}
\end{column}
...
\begin{column}{0.42\textwidth}
\figuraabnt[
  legenda={Sistema massa-mola (Lei de Hooke)},    % EDITAR
  fonte={Elaborado pelo autor (2026).},
  rotulo=fig:hooke,
  largura=0.90\linewidth
]{figuras/lei_hooke.png}
\end{column}
